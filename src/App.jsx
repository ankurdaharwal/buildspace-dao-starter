...
const memberList = useMemo(() => {
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to MetaversityDAO</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h2 className="rainbow">MetaversityDAO</h2>
        <h2>🎉 Congratulations on becoming a Gold Member 🏅</h2>
        <h3>🏫🧑🏻‍🤝‍🧑🏼🧑🏽‍🤝‍🧑🏾🏢🧑🏿‍🤝‍🧑🏾 Let's shape the future of Metaverse Cities together 🧑🏻‍🤝‍🧑🏿🏢🧑🏽‍🤝‍🧑🏼🧑🏻‍🤝‍🧑🏿🏫</h3>
        <div>
        <div>
          <h2>Member List</h2>
  ...
  return (
    <div className="mint-nft">
      <h2>Mint your free </h2>
        <span className="rainbow">MetaversityDAO</span> 
